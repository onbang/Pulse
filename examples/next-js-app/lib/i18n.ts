...
export const messages = {
  en: {
    ...
    "checkin.subtitle":
      "Confirm your daily visit with a minimal 0.001 TON transaction and keep your streak alive.",
    ...
    "checkin.confirmBody":
      "Send a minimal 0.001 TON confirmation transfer to lock today's check-in and receive +10 points.",
  ...
  ru: {
    ...
    "checkin.subtitle":
      "Подтверждай ежедневный визит минимальной транзакцией 0.001 TON и поддерживай свою серию.",
    ...
    "checkin.confirmBody":
      "Отправь минимальную транзакцию 0.001 TON, чтобы зафиксировать сегодняшний чек-ин и получить +10 points.",
