...
export declare function storeLockMarket(
  src: LockMarket,
): (builder: Builder) => void;
...
export declare function storeResolveMarket(
  src: ResolveMarket,
): (builder: Builder) => void;
...
export declare function storeTupleResolveMarket(
  source: ResolveMarket,
): TupleItem[];
export declare function dictValueParserResolveMarket(): DictionaryValue<ResolveMarket>;
export type ClaimReward = {
  $$type: "ClaimReward";
};
export declare function storeClaimReward(
  src: ClaimReward,
): (builder: Builder) => void;
...
export declare function storeMarketState(
  src: MarketState,
): (builder: Builder) => void;
...
export declare function storeTonForecastMarket$Data(
  src: TonForecastMarket$Data,
): (builder: Builder) => void;
...
export declare function loadGetterTupleTonForecastMarket$Data(
  source: TupleReader,
): {
  $$type: "TonForecastMarket$Data";
  owner: Address;
...
export declare function storeTupleTonForecastMarket$Data(
